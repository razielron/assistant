...
const exportMimeTypeToExtension: { [key: string]: string } = {
...
function getExportMimeType(originalMimeType: string): string {
  return mimeTypeMapping[originalMimeType] || originalMimeType;
}

function getExtensionFromExportMimeType(exportMimeType: string): string {
